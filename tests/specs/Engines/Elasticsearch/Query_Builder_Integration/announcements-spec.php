        ...
        $this->expect( $this->database ) ->during( function() {
            ...
            function($announcement){
                ...
                $this->expect( $announcement->__toString() ) ->to()
                    ->equal( 'Haijin\Persistency\Engines\Elasticsearch\Elasticsearch_Database about to execute: \'search\' with parameters: \'{"index":"users_read_only","type":"users_read_only","body":{"query":{"match":{"name":"Lisa"}}},"sort":[]}\'' );
