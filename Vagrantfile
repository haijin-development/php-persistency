...
Vagrant.configure("2") do |config|
  ...
  config.vm.provision "shell", inline: <<-SHELL
    ...
    # Required
    bash src/php-persistency/provision-scritps/required.sh

    # PHP
    bash src/php-persistency/provision-scritps/php.sh

    # Composer
    bash src/php-persistency/provision-scritps/composer.sh

    # Sqlite
    bash src/php-persistency/provision-scritps/sqlite.sh

    # Mysql
    bash src/php-persistency/provision-scritps/mysql.sh
